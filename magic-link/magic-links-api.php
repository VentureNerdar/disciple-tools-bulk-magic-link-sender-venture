...
Thanks!';
    ...
    // --------------------------------
    #region VENTURE CUSTOMS : NERDAR CHANGES
    // --------------------------------




    #region SORT ORDER FEATURE

    #region SET API METHODS ##

    // Set API endpoint for fetching magic link fields sort order
    ...
    // Set API endpoint for fetching magic link fields sort order exists
    ...
    // Set API endpoint for updating magic link fields sort order
    ...
    // Set API endpoint for adding magic link fields sort order
    ...
    #endregion SET API METHODS ##


    #region Get Methods
    // Get magic link fields sort order
    ...
    #endregion SORT ORDER FEATURE


    // --------------------------------


    #region CUSTOM BRANDING FEATURE

    #region SET API METHODS ##

    #region Name : OLD
    // Set API endpoint for updating custom branding
    public static function fetch_endpoint_update_magic_link_custom_branding() {
        return trailingslashit(site_url()) . 'wp-json/disciple_tools_magic_links/v1/update_magic_link_custom_branding';
    }

    // Set API endpoint for adding custom branding
    public static function fetch_endpoint_add_magic_link_custom_branding() {
        return trailingslashit(site_url()) . 'wp-json/disciple_tools_magic_links/v1/add_magic_link_custom_branding';
    }
    #endregion Name : OLD

    #region Icon
    // Set API endpoint for fetching custom branding icon
    public static function fetch_endpoint_handle_upload_custom_branding_icon() {
        return trailingslashit(site_url()) . 'wp-json/disciple_tools_magic_links/v1/handle_upload_custom_branding_icon';
    }

    // Set API endpoint for getting custom branding icon
    public static function fetch_endpoint_get_custom_branding_icon() {
        return trailingslashit(site_url()) . 'wp-json/disciple_tools_magic_links/v1/get_custom_branding_icon';
    }

    // Set API endpoint for deleting custom branding icon
    public static function fetch_endpoint_delete_custom_branding_icon() {
        return trailingslashit(site_url()) . 'wp-json/disciple_tools_magic_links/v1/delete_custom_branding_icon';
    }
    #endregion Icon

    #region Display Options
    // Set API endpoint for saving custom branding display options
    public static function fetch_endpoint_save_custom_branding_display_options() {
        return trailingslashit(site_url()) . 'wp-json/disciple_tools_magic_links/v1/save_custom_branding_display_options';
    }

    // SET API enpoint for getting custom branding display options
    public static function fetch_endpoint_get_custom_branding_display_options() {
        return trailingslashit(site_url()) . 'wp-json/disciple_tools_magic_links/v1/get_custom_branding_display_options';
    }
    #endregion Display Options

    #region Enable
    // SET API endpoint for saving custom branding enable
    public static function fetch_endpoint_save_custom_branding_enable() {
        return trailingslashit(site_url()) . 'wp-json/disciple_tools_magic_links/v1/save_custom_branding_enable';
    }

    // SET API endpoint for getting custom branding enable
    public static function fetch_endpoint_get_custom_branding_enable() {
        return trailingslashit(site_url()) . 'wp-json/disciple_tools_magic_links/v1/get_custom_branding_enable';
    }
    #endregion Enable
    ...
    #region Name
    // SET API endpoint for fetching custom branding name
    public static function fetch_endpoint_get_custom_branding_name() {
        return trailingslashit(site_url()) . 'wp-json/disciple_tools_magic_links/v1/get_custom_branding_name';
    }

    // SET API endpoint for saving custom branding name
    public static function fetch_endpoint_save_custom_branding_name() {
        return trailingslashit(site_url()) . 'wp-json/disciple_tools_magic_links/v1/save_custom_branding_name';
    }
    #endregion Name
    ...
    // Get custom branding
    public static function magic_link_custom_branding() {
        global $wpdb;
        ...
        $response = $wpdb->get_results(
            "
                SELECT * 
                FROM $wpdb->options
                WHERE option_name = 'magic_link_custom_branding'
            ",
            ARRAY_A
        );
    ...
    #endregion CUSTOM BRANDING FEATURE




    // --------------------------------
    #endregion VENTURE CUSTOMS : NERDAR CHANGES
    // --------------------------------
}
